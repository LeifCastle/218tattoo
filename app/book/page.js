...
export default function Book() {
    ...
    let inputField = `w-full rounded-md pl-2 text-black bg-inputBg border-2 border-black focus:border-teal-600 focus:outline-none hover:bg-inputHoverBg focus:bg-inputHoverBg`
        ...
        <>
            ...
            <form onSubmit={handleBooking} className={`${booked ? 'opacity-[.3]' : ''} bg-white opacity-90 bg-cover min-h-[50vh] relative flex flex-col items-center`}>
                ...
                <div className='w-full relative'>
                    ...
                    <div className={`${scrolled ? 'text-gray-300 scale-[1]' : 'scale-[1.25] text-white'} ease-in-out duration-500 text-white text-6xl absolute top-0 left-0 w-full min-h-[375px] flex items-center justify-center`}>
                        <p>Book Your Appointment</p>
                    </div>
                </div>
                {/*---Booking Form---*/}
                <div className={`${scrolled ? 'mt-[-100px]' : ''} bg-white w-full z-[2] flex flex-col items-center transition-all duration-500`}>
                    {/*---Progress Bar---*/}
